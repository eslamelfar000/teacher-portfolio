...
import layeredDepthData from "./layeredDepthData.json";

gsap.registerPlugin(ScrollTrigger);

const LAYERS = layeredDepthData.layers;
...
export default function LayeredDepthSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      const layers = [
        { ref: layer0, speed: LAYERS[0].speed },
        { ref: layer1, speed: LAYERS[1].speed },
        { ref: layer2, speed: LAYERS[2].speed },
        { ref: layer3, speed: LAYERS[3].speed },
        { ref: layer4, speed: LAYERS[4].speed },
      ];
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          bottom: "-20%",
          background:
            "radial-gradient(ellipse 120% 80% at 40% 50%, hsl(185 60% 8% / 1) 0%, hsl(222 25% 3%) 70%)",
        }}
      />
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(185 100% 40% / 0.12) 0%, transparent 70%)",
            filter: "blur(30px)",
          }}
        />
        {/* Bottom-right blob */}
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(340 85% 50% / 0.10) 0%, transparent 70%)",
            filter: "blur(25px)",
          }}
        />
        {/* Square outline top-right */}
        <div className="absolute top-[10%] right-[15%] w-32 h-32 border border-[hsl(185_100%_55%/0.12)] rotate-45" />
        {/* Square outline bottom-left */}
        <div className="absolute bottom-[25%] left-[12%] w-20 h-20 border border-[hsl(340_85%_62%/0.1)] rotate-12" />
      </div>
      ...
      >
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, hsl(185 60% 12% / 0.9) 0%, hsl(340 40% 8% / 0.9) 100%)",
            }}
          />
          {/* Inner grid */}
          <div
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
            <div
              ...
              style={{
                boxShadow:
                  "0 0 30px hsl(185 100% 55% / 0.2), inset 0 0 20px hsl(185 100% 55% / 0.1)",
              }}
            />
            <div className="w-8 h-px bg-[hsl(185_100%_55%/0.4)]" />
            <p className="text-xs tracking-[0.3em] uppercase text-[hsl(185_100%_55%/0.5)]">
              Visual
            </p>
          </div>
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, transparent, hsl(185 100% 55% / 0.4), transparent)",
            }}
          />
        </div>
        ...
        >
          <div
            className="w-2 h-2 rounded-full bg-[hsl(185_100%_55%)]"
            style={{ boxShadow: "0 0 8px hsl(185 100% 55% / 0.8)" }}
          />
      ...
      >
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at 30% 70%, hsl(340 60% 15% / 0.8) 0%, transparent 70%)",
            }}
          />
          <div className="absolute inset-0 flex items-center justify-center">
            <span
              className="text-5xl"
              style={{ color: "hsl(340 85% 62% / 0.25)", fontFamily: "serif" }}
            >
              ◈
            </span>
          </div>
      ...
      >
        <div className="text-center px-8 max-w-3xl">
          <p className="section-label mb-8 depth-reveal" style={{ opacity: 0 }}>
            Immersive Learning
          </p>
          <h2
          ...
          <p
            ...
            style={{ opacity: 0 }}
          >
            Language learning is multifaceted. Vocabulary, grammar,
            pronunciation, listening, and speaking — when combined effectively,
            they create true confidence and fluency.
          </p>
          <button
