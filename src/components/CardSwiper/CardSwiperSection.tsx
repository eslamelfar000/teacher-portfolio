...
import cardSwiperData from "./cardSwiperData.json";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 60% at 50% 50%, hsl(185 50% 6% / 0.9) 0%, transparent 100%)",
        }}
      />
                ...
                >
                  ...
                  <div className="relative h-full p-8 md:p-10 flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <h3 className="display-text text-3xl md:text-4xl font-bold mb-4 text-[hsl(var(--foreground))]">
                        {card.title}
                      </h3>
          ...
          <div className="hidden lg:flex flex-col gap-6">
            {CARDS.map((card, i) => (
              ...
              >
                ...
                />
                <span className="text-sm text-[hsl(var(--foreground)/0.7)]">
                  {card.title}
                </span>
              </div>
            ))}
