...
const WORDS = [
  ...
  },
  {
    ...
    color: "text-[hsl(var(--muted-foreground)/0.4)]",
    weight: "font-light",
    italic: false,
  },
  {
    ...
    <section ref={sectionRef} className="relative py-32 overflow-hidden">
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(185 40% 8% / 0.8) 0%, transparent 65%)",
          }}
        />
        {/* Subtle cross grid */}
        <div
      ...
      <div ref={layerMidRef} className="absolute inset-0 pointer-events-none">
        ...
        />
        <div className="absolute bottom-24 right-[8%] w-24 h-24 border border-[hsl(var(--accent)/0.15)] rounded-full" />
        <div
