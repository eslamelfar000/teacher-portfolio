...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative overflow-hidden border-t border-[hsl(var(--border))]"
    >
      {/* Big brand text */}
      <div
        ref={bigTextRef}
      ...
      <div className="footer-bottom border-t border-[hsl(var(--border))] px-8 py-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 10px hsl(185 100% 55% / 0.4)",
              }}
            />
          ...
          <div className="flex items-center gap-8">
            {footerData.footerItems.map((link) => (
              <button
                key={link.label}
          ...
          <div
            className="flex flex-col items-center md:items-end gap-1 footer-item"
            style={{ opacity: 0 }}
          >
