        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
          ...
          <div ref={leftRef} className="lg:col-span-2" style={{ opacity: 0 }}>
            ...
            <p className="text-[hsl(var(--muted-foreground))] leading-relaxed mb-10 text-sm max-w-sm">
              I combine interactive teaching methods with personalized feedback
              to ensure continuous rapid progress.
            </p>
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, hsl(185 40% 8%) 0%, hsl(185 40% 10%) 100%)",
                }}
              />
              {/* Geometric shapes */}
              <div
                ...
                style={{ borderRadius: "2px" }}
              />
              <div className="absolute bottom-6 right-6 w-16 h-16 rounded-full border border-[hsl(var(--accent)/0.4)]" />
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 rounded-full"
                style={{
                  background:
                    "radial-gradient(circle, hsl(185 100% 55% / 0.2) 0%, transparent 70%)",
                }}
              />
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-6xl font-serif text-[hsl(var(--primary)/0.3)] select-none">
                  ✦
                </span>
              </div>
            </div>
