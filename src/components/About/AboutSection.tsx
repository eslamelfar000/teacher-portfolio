...
const TEAM = [
  {
    name: "Bachelor of Arts and Education",
    role: "(English Department), Faculty of Education, Damietta University",
    initials: "BAE",
  },
  {
    name: "Online Teaching Course",
    role: "(Effective Virtual Teaching Strategies & Tools)",
    initials: "OTC",
  },
  {
    name: "Educational Training Course",
    role: "(Teaching Methods & Classroom Management)",
    initials: "ETC",
  },
];
      ...
      <div className="relative z-10 px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-24">
          ...
          <div ref={textBlockRef}>
            <p
              className="section-label mb-8 reveal-line"
              style={{ opacity: 0 }}
            >
              About Me
            </p>
            ...
            <p
              className="text-[hsl(var(--muted-foreground))] leading-relaxed mb-6 reveal-line"
              style={{ opacity: 0 }}
            >
              With years of experience, I am dedicated to empowering students to
              achieve their language goals through personalized and engaging
              instruction. I believe that communication has the power to open
              doors and change lives.
            </p>
            <p
              className="text-[hsl(var(--muted-foreground))] leading-relaxed mb-10 reveal-line"
              style={{ opacity: 0 }}
            >
              I work globally with students online and locally, helping them
              communicate with confidence and clarity in any environment.
            </p>
          ...
          <div ref={imageBlockRef} className="relative">
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, hsl(222 30% 8%) 0%, hsl(185 30% 12%) 50%, hsl(270 20% 8%) 100%)",
                }}
              />
              {/* Teacher Image */}
              <img
              ...
              <div className="absolute top-12 left-12 w-32 h-32 border border-[hsl(var(--primary)/0.3)] rotate-45" />
              <div className="absolute bottom-12 right-12 w-24 h-24 border border-[hsl(var(--accent)/0.3)] rounded-full" />
              <div
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 border border-[hsl(var(--primary)/0.5)] rounded-full" />
              {/* Studio label */}
              <div className="absolute top-6 right-6 text-right">
                <p className="text-xs text-[hsl(var(--muted-foreground))] tracking-widest uppercase">
                  Est.
                </p>
                <p className="text-2xl font-serif text-[hsl(var(--primary)/0.6)]">
                  2026
                </p>
              </div>
            </div>
