        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-0">
          ...
          >
            <div className="relative group">
              ...
              <div className="absolute inset-0 md:-inset-6 lg:-inset-8 opacity-60">
                <div
                  className="absolute top-0 right-0 w-24 h-24 md:w-32 md:h-32 bg-[hsl(var(--primary)/0.3)] rounded-full blur-3xl animate-pulse"
                  style={{ animationDuration: "3s" }}
                />
                <div
                  className="absolute bottom-0 left-0 w-32 h-32 md:w-40 md:h-40 bg-[hsl(340,85%,62%/0.2)] rounded-full blur-3xl animate-pulse"
              ...
              <div className="relative w-64 h-80 sm:w-72 sm:h-96 md:w-96 md:h-[32rem] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-[hsl(var(--background))]">
                ...
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src =
                      "https://ui-avatars.com/api/?name=Sara+Osama&size=500&background=14b8a6&color=fff&bold=true&font-size=0.35";
                  }}
                />
              </div>
              ...
              <div className="hidden sm:block absolute -left-6 md:-left-8 top-1/4 bg-[hsl(var(--background))] border-2 border-[hsl(var(--primary))] rounded-2xl px-3 py-2 md:px-4 md:py-3 shadow-xl backdrop-blur-sm group-hover:-translate-x-2 transition-transform duration-300">
                <div className="text-xl md:text-2xl font-bold gradient-text">
                  {heroData.about.stats[0].number}
                </div>
                <div className="text-[0.65rem] md:text-xs text-[hsl(var(--muted-foreground))]">
                  {heroData.about.stats[0].label}
                </div>
              </div>
              ...
              <div className="hidden sm:block absolute -right-6 md:-right-8 bottom-1/3 bg-[hsl(var(--background))] border-2 border-[hsl(340,85%,62%)] rounded-2xl px-3 py-2 md:px-4 md:py-3 shadow-xl backdrop-blur-sm group-hover:translate-x-2 transition-transform duration-300">
                <div
                  ...
                  style={{ color: "hsl(340,85%,62%)" }}
                >
                  {heroData.about.stats[1].number}
                </div>
                <div className="text-[0.65rem] md:text-xs text-[hsl(var(--muted-foreground))]">
                  {heroData.about.stats[1].label}
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p
              ...
              style={{ opacity: 0 }}
            >
              Turning confusion into clarity — one English lesson at a time.
              Dedicated English teacher helping preparatory and secondary
              students simplify English, build confidence, and achieve real exam
              success.
            </p>
            ...
            {/* Decorative line */}
            <div
              className="hidden lg:block mt-12 hero-cta"
              style={{ opacity: 0 }}
            >
              <div className="flex items-center gap-4">
                <div className="h-px w-20 bg-gradient-to-r from-[hsl(var(--primary))] to-transparent" />
                <span className="text-xs text-[hsl(var(--muted-foreground))] tracking-widest">
                  SCROLL TO EXPLORE
                </span>
              </div>
            </div>
