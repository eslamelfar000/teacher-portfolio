...
export default function Nav() {
  ...
  return (
    <nav
      ...
      style={{
        background:
          "linear-gradient(to bottom, hsl(222 25% 4% / 0.95) 0%, transparent 100%)",
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <div
          className="w-7 h-7 rounded-full bg-[hsl(var(--primary))]"
          style={{ boxShadow: "0 0 20px hsl(185 100% 50% / 0.5)" }}
        />
        <span className="text-sm font-semibold tracking-widest uppercase text-[hsl(var(--foreground))]">
          Sara Osama
        </span>
      </div>
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2 px-6 py-6 border-b border-[hsl(var(--border))]">
            <div
              className="w-6 h-6 rounded-full bg-[hsl(var(--primary))]"
              style={{ boxShadow: "0 0 14px hsl(185 100% 50% / 0.5)" }}
            />
