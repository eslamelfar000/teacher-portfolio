  ...
  return (
    <div ref={itemRef} className="text-center" style={{ opacity: 0 }}>
      <div className="counter-number mb-2">
        ...
        <span style={{ color: "hsl(var(--primary))", fontFamily: "inherit" }}>
          {stat.suffix}
        </span>
      </div>
  ...
  return (
    <section ref={sectionRef} className="py-32 px-8 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 80% at 50% 50%, hsl(185 40% 8% / 0.8) 0%, transparent 100%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="h-px bg-gradient-to-r from-transparent via-[hsl(var(--border))] to-transparent mt-20" />
      </div>
    </section>
  );
}
